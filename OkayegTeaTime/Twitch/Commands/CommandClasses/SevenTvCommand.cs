    ...
    public override void Handle()
    {
        ...
        if (channelWithCountPattern.IsMatch(ChatMessage.Message))
        {
            TwitchBot.Send(ChatMessage.Channel,
                BotActions.SendSevenTvEmotes(ChatMessage, ChatMessage.Split[1], ChatMessage.Split[2].ToInt()));
        ...
        {
            TwitchBot.Send(ChatMessage.Channel,
                BotActions.SendSevenTvEmotes(ChatMessage, count: ChatMessage.Split[1].ToInt()));
