    ...
    : IChatCommand<BanFromFileCommand>
{
    ...
    public override bool Equals(object? obj) => obj is BanFromFileCommand other && Equals(other);

    public override int GetHashCode() => HashCode.Combine(_twitchBot, _prefix, _alias, Response, ChatMessage);

    public static bool operator ==(BanFromFileCommand left, BanFromFileCommand right) => left.Equals(right);
