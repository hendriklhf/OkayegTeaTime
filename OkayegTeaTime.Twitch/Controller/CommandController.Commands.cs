...
public static partial class CommandController
{
    ...
    private static class CommandDataStorage
    {
        ...
        [
            new()
            {
                ...
                Parameters =
                [
                    new("(none)", "Sends useful Chatterino links, e.g. for download")
                ],
            ...
            new()
            {
                ...
                Parameters =
                [
                    new("(none)", "Sends useful Chatterino7 links, e.g. for download")
                ],
                Cooldown = TimeSpan.FromSeconds(10),
                Document = true
            },
            ...
            new()
            {
                ...
                Parameters =
                [
                    new("(none)", "Sends information about the next Formula 1 event"),
            ...
            new()
            {
                ...
                Parameters =
                [
                    new("[username]", "Fucks the given user"),
            ...
            new()
            {
                ...
                Parameters =
                [
                    new("(none)", "Sends a random gachi song")
                ],
                Cooldown = TimeSpan.FromSeconds(10),
                Document = true
            },
            ...
            new()
            {
                ...
                Parameters =
                [
                    new("(none)", "Sends a link to the GitHub repository")
                ],
                Cooldown = TimeSpan.FromSeconds(5),
                Document = true
            },
            new()
            {
                ...
                Parameters =
                [
                    new("(none)", "Sends your Twitch user id"),
                    new("[username]", "Sends the Twitch user id of the given user")
                ],
                Cooldown = TimeSpan.FromSeconds(10),
                Document = true
            },
            new()
            {
                ...
                Parameters =
                [
                    new("(none)", "Invalidates all database caches")
                ],
                Cooldown = TimeSpan.FromSeconds(10),
                Document = false
            },
            ...
            new()
            {
                ...
                Parameters =
                [
                    new("[username]", "Lets you listen along with another user")
                ],
                Cooldown = TimeSpan.FromSeconds(30),
                Document = false
            },
            new()
            {
                ...
                Parameters =
                [
                    new("(none)", "Pings all users in the current channel"),
            ...
            new()
            {
                ...
                Parameters =
                [
                    new("(none)", "Sends a ping message, if the bot is online")
                ],
                Cooldown = default,
                Document = false
            },
            new()
            {
                ...
                Parameters =
                [
                    new("(none)", "Resumes your last afk status")
                ],
                Cooldown = TimeSpan.FromSeconds(5),
                Document = true
            },
            ...
            new()
            {
                ...
                Parameters =
                [
                    new("(none)", "Skips to the next song in the broadcaster's queue, if registered and enabled")
                ],
                Cooldown = TimeSpan.FromSeconds(5),
                Document = true
            },
            new()
            {
                ...
                Parameters =
                [
                    new("(none)", "Rolls slots and picks 3 of all emotes"),
            ...
            new()
            {
                ...
                Parameters =
                [
                    new("(none)", "Sends the current playing spotify song of the broadcaster, if registered"),
                    new("me", "Sends your current playing spotify song, if registered"),
                    new("[username]", "Sends the current playing spotify song of the given user, if registered")
                ],
                Cooldown = TimeSpan.FromSeconds(10),
                Document = true
            },
            new()
            {
                ...
                Parameters =
                [
                    new("(none)", "Sends information about the current channel's stream"),
            ...
            new()
            {
                ...
                Parameters =
                [
                    new("[message]", "Suggest or report anything concerning the bot with a provided message attached")
                ],
                Cooldown = TimeSpan.FromSeconds(10),
                Document = true
            },
            new()
            {
                ...
                Parameters =
                [
                    new("[username]", "Tucks the given user to bed"),
            ...
            new()
            {
                ...
                Parameters =
                [
                    new("(none)", "Timeouts the sender for 1s")
                ],
                Cooldown = TimeSpan.FromSeconds(5),
                Document = true
            },
        ...
        [
            new()
            {
                ...
                Parameters =
                [
                    new("[message]", "Sets your status to \"afk\"")
                ],
                Document = true
            },
            new()
            {
                ...
                Parameters =
                [
                    new("[message]", "Sets your status to \"brb\"")
                ],
                Document = true
            },
            new()
            {
                ...
                Parameters =
                [
                    new("[message]", "Sets your status to \"eating\"")
                ],
                Document = true
            },
            new()
            {
                ...
                Parameters =
                [
                    new("[message]", "Sets your status to \"gaming\"")
                ],
                Document = true
            },
            new()
            {
                ...
                Parameters =
                [
                    new("[message]", "Sets your status to \"sleeping\"")
                ],
                Document = true
            },
            new()
            {
                ...
                Parameters =
                [
                    new("[message]", "Sets your status to \"lurking\"")
                ],
                Document = true
            },
            new()
            {
                ...
                Parameters =
                [
                    new("[message]", "Sets your status to \"watching a movie\"")
                ],
                Document = true
            },
            new()
            {
                ...
                Parameters =
                [
                    new("[message]", "Sets your status to \"napping\"")
                ],
                Document = true
            },
            new()
            {
                ...
                Parameters =
                [
                    new("[message]", "Sets your status to \"peeing\"")
                ],
                Document = true
            },
            new()
            {
                ...
                Parameters =
                [
                    new("[message]", "Sets your status to \"poofed away\"")
                ],
                Document = true
            },
            new()
            {
                ...
                Parameters =
                [
                    new("[message]", "Sets your status to \"pooping\"")
                ],
                Document = true
            },
            new()
            {
                ...
                Parameters =
                [
                    new("[message]", "Sets your status to \"at school\"")
                ],
                Document = true
            },
            new()
            {
                ...
                Parameters =
                [
                    new("[message]", "Sets your status to \"showering\"")
                ],
                Document = true
            },
            new()
            {
                ...
                Parameters =
                [
                    new("[message]", "Sets your status to \"studying\"")
                ],
                Document = true
            },
            new()
            {
                ...
                Parameters =
                [
                    new("[message]", "Sets your status to \"working\"")
                ],
                Document = true
            },
            new()
            {
                ...
                Parameters =
                [
                    new("[message]", "Sets your status to \"listening to music\"")
                ],
                Document = true
            },
            new()
            {
                ...
                Parameters =
                [
                    new("[message]", "Sets your status to \"fapping\"")
                ],
                Document = false
            },
            new()
            {
                ...
                Parameters =
                [
                    new("[message]", "Sets your status to \"working out\"")
                ],
                Document = true
            }
        ];
